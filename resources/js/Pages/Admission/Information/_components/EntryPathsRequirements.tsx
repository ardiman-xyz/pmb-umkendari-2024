...
export const EntryPathsRequirements = ({defaultData}: RoadmapProps) => {
    ...
    const onUpload = () => {
        ...
        formData.append("entry_paths_requirements", file);
    ...
    return (
        <div>
          <div className="flex justify-between items-center">
              <HeadingInfo title={"JALUR MASUK DAN PERSYARATAN"}>
                  <h2>Keterangan :</h2>
              ...
              <Button variant="ghost" onClick={toggleEdit}>
                  ...
                  {
                      !isEditing && !defaultData?.entry_paths_requirements && (
                          <>
            ...
            <div className="mt-3">
...

                {
                    !isEditing && (
                        <>
                                {!defaultData?.entry_paths_requirements ? (
                                    ...
                                    <a href={defaultData.entry_paths_requirements} target="_blank"
